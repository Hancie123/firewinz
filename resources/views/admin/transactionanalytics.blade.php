...
@push('title')
<title>Firewinz | Transaction Analytics</title>
...
<script src="https://cdn.datatables.net/buttons/1.7.1/js/buttons.print.min.js"></script>
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <h3><b>Transactions Analytics</b></h3><br>
  ...
  <!-------- 15 days data ------->
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Transaction analytics of 15 days',
...
<!-------- 30 days data ------->
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Transaction analytcis of 30 days',
          hAxis: {title: 'Date',  titleTextStyle: {color: '#333'}},
          vAxis: {minValue: 0}
        };
...
<!-------- 30 days data ------->
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Transaction analytcis of all time',
          hAxis: {title: 'Date',  titleTextStyle: {color: '#333'}},
          vAxis: {minValue: 0}
        };
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'The total transactions done by users',
          is3D: true,
        };

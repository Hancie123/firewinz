        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="managereport">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{url('/admin/clockreport/view')}}">Clock
                                        Report</a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#graphreport" aria-expanded="false"
                            aria-controls="graphreport">
                            <i class='bx bx-bar-chart-alt-2 bx-sm mx-1'></i>
                            <span class="menu-title">Graph Reports</span>
                            <i class='bx bx-chevron-right'></i>
                        </a>

                        <div class="collapse" id="graphreport">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{url('/admin/firewinz-analytics/transaction-analytics')}}">Transaction
                                        Analytics</a>
                                </li>

                                <li class="nav-item"> <a class="nav-link"
                                        href="{{url('/admin/firewinz-analytics/clock-analytics')}}">Clock Analytics</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{url('/admin/firewinz-analytics/cashin-cashout-analytics')}}">Cash
                                        Analytics</a>
                                </li>
